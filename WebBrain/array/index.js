...
ar[10] = "sam"
console.log(ar)
//toString() stringga ozgartiradi/ join(",") stringa ozgartiradi joinni ichiga parametr kirgizdirsak ozgartirganda itemlar orasiga shu parametrni qoshib chiqadi
let arr1 = [1, 2, 3, 4, 5]
let arr2 = [1, 2, 3, 4, 5]
...
console.log(arr2.indexOf(1)) //indexOf ichidagi parametr arrayni qaysi indexida borligini chiqarib beradi, malutmot yoq bolsa -1 chiqarib beradi
//lekin bir xil itemlar kop bolsa ham faqat 1chi korgan itemda toxtaydi, shunda indexOf ichiga 2chi parametr kirgissak, nechanchi parametdan boshlab qidirsh kerakligini bildiradi
